...
class BiLSTM_CRF(nn.Module):
    ...
    def neg_log_likelihood(self, word_ids, char_ids, tags, lengths):
        ...
        # Calculate score and partition function
        gold_score = self._score_sentence(emissions, tags, mask)
        log_norm = self._forward_algorithm(emissions, mask)
        
        return torch.mean(log_norm - gold_score)
...
def main():
    # Load data
    train_path = '/home/muarora/NLP 202/A2/A2-data/train'  # Update with your path
    dev_path = '/home/muarora/NLP 202/A2/A2-data/dev'
    test_path = '/home/muarora/NLP 202/A2/A2-data/test'
